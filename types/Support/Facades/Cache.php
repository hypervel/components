...
assertType('mixed', Cache::remember('cache', CarbonImmutable::now(), function (): int {
    return 36;
}));
assertType('array', Cache::rememberWithWarmth('cache', CarbonImmutable::now(), function (): int {
    return 36;
}));
