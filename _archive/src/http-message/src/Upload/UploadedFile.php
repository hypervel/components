...
namespace Hypervel\HttpMessage\Upload;
...
class UploadedFile extends SplFileInfo implements UploadedFileInterface, Stringable
{
     ...
     *
     * @param int $error The error associated with the uploaded file (one of PHP's UPLOAD_ERR_XXX constants)
    ...
    /**
     * Get the JSON representation of the uploaded file.
     */
    ...
    /**
     * Get the file extension from the client filename.
     */
    ...
    /**
     * Get the uploaded file data as an array.
     */
    ...
    /**
     * Validate the upload error status.
     */
    ...
    /**
     * Determine if the given value is a non-empty string.
     */
    ...
    /**
     * Validate that the upload was successful and the file has not been moved.
     *
