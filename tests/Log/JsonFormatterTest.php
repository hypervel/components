...
final class JsonFormatterTest extends TestCase
{
    ...
    public function testStackDriverEnrichesBothHandlersOnDirectLogging(): void
    {
    ...
    public function testStackDriverSkipsEnrichmentOnBothHandlersWhenReporting(): void
    {
        $handlerA = new TestHandler;
        $handlerB = new TestHandler;
    ...
    public function testPreviousExceptionContextIsAlsoEnriched(): void
    {
    ...
    public function testReportEnrichesPreviousExceptionContext(): void
    {
    ...
    public function testExceptionWithoutContextMethodIsNotEnriched(): void
    {
    ...
    public function testBothOuterAndPreviousContextEnrichedOnDirectLogging(): void
    {
        $previous = new ContextProvidingException('Root cause');
    ...
    public function testBothOuterAndPreviousContextOnReport(): void
    {
        $previous = new ContextProvidingException('Root cause');
        $outer = new AnotherContextProvidingException('Wrapper', 0, $previous);
    ...
    public function testFormatterHandlesNormalizationDepthLimit(): void
    {
