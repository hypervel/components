...
class SupportStrTest extends TestCase
{
    ...
    {
        $uuid = Uuid::fromString('00000000-0000-0000-0000-000000001234');

        try {
            Str::freezeUuids(function () {
                Str::createUuidsUsing(fn () => Uuid::fromString('00000000-0000-0000-0000-000000001234'));
                $this->assertSame('00000000-0000-0000-0000-000000001234', Str::uuid()->toString());
                throw new Exception('Something failed.');
            });
        } catch (Exception) {
            $this->assertNotSame($uuid->toString(), Str::uuid()->toString());
        }
    }
    ...
    public function testItCreatesUlidsNormallyAfterFailureWithinFreezeMethod()
    {
        ...
        try {
            Str::freezeUlids(function () {
                Str::createUlidsUsing(fn () => new Ulid('01ARZ3NDEKTSV4RRFFQ69G5FAV'));
