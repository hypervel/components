...
use Hypervel\Tests\Database\Hyperf\Stubs\KeyTypeModelStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelAppendsStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelBootingTestStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelCamelStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelCastingStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelDestroyStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelDynamicHiddenStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelDynamicVisibleStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelEventObjectStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelFindWithWritePdoStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelGetMutatorsStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelNonIncrementingStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelSaveStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelSavingEventStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelStubWithTrait;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelStubWithUlid;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelStubWithUuid;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelWithoutRelationStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelWithoutTableStub;
use Hypervel\Tests\Database\Hyperf\Stubs\ModelWithStub;
use Hypervel\Tests\Database\Hyperf\Stubs\NoConnectionModelStub;
 ...
 * @coversNothing
 */
class ModelTest extends \Hypervel\Testbench\TestCase
{
    ...
    public function testGetModelAttributeMethodThrowsExceptionIfNotRelation()
    {
        ...
        $this->expectExceptionMessage('Hypervel\Tests\Database\Hyperf\Stubs\ModelStub::incorrectRelationStub must return a relationship instance.');
        $model = new ModelStub();
    ...
    public function testModelAttributeCastingFailsOnUnencodableData()
    {
        ...
        $this->expectExceptionMessage('Unable to encode attribute [objectAttribute] for model [Hypervel\Tests\Database\Hyperf\Stubs\ModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
    ...
    {
        // Use ContainerStub for SQLite connection
        ...
        $connection = $connectionResolverInterface->connection();
        $connection->statement('CREATE TABLE IF NOT EXISTS user (id INTEGER PRIMARY KEY, name VARCHAR(255))');
        $connection->statement('INSERT INTO user (id, name) VALUES (1, "Test User 1")');
        ...
        $meta = $user->compress();
        $s2 = serialize($meta);
        $this->assertLessThan(strlen($s1), strlen($s2));
    ...
    public function testCollectionGenerate()
    {
        ...
        $connection = $connectionResolverInterface->connection();
        $connection->statement('CREATE TABLE IF NOT EXISTS user (id INTEGER PRIMARY KEY, name VARCHAR(255))');
        $connection->statement('INSERT INTO user (id, name) VALUES (1, "Test User 1"), (2, "Test User 2")');
