...
use Hypervel\Tests\Database\Hyperf\Stubs\Model\Book;
 ...
 * @coversNothing
 */
class ModelCollectionTest extends \Hypervel\Testbench\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $dispatcher->shouldReceive('dispatch')->with(m::any())->andReturnUsing(function ($event) {
            // Skip channel push in test environment - not needed for these tests
        });
    ...
    public function testFindOrFailFindsManyModelsById()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Hypervel\Tests\Database\Hyperf\TestUserModel] 3');
    ...
    public function testFindOrFailThrowsExceptionWithMessageWhenOtherModelsArePresent()
    {
        ...
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Hypervel\Tests\Database\Hyperf\TestUserModel] 2');
