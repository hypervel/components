...
namespace Hypervel\Tests\Integration\Console\Scheduling\ScheduleListCommandTest;
...
class ScheduleListCommandTest extends TestCase
{
    ...
    public function testDisplaySchedule()
    {
        ...
        $this->artisan(ScheduleListCommand::class)
            ...
            ->expectsOutput("  * *     * *      *  {$ns}\\FooJob  Next Due: 1 minute from now")
            ->expectsOutput("  * *     * *      *  {$ns}\\FooParamJob  Next Due: 1 minute from now")
            ...
            ->expectsOutput("  * *     * *      *  {$ns}\\FooCall  Next Due: 1 minute from now")
            ->expectsOutput("  * *     * *      *  Closure at: {$ns}\\FooCall::fooFunction  Next Due: 1 minute from now")
    ...
    public function testDisplayScheduleAsJson()
    {
        ...
        $this->assertSame("{$ns}\\FooJob", $data[3]['command']);
    ...
    public function testDisplayScheduleWithEnvironmentFilterAsJson(): void
    {
        ...
        $this->assertSame(FooJob::class, $data[1]['command']);
        $this->assertSame([], $data[1]['environments']);
    }

    public function testDisplayScheduleWithMultipleEnvironmentFilterAsJson(): void
    {
        $this->schedule->command(FooCommand::class)->environments('production')->everyMinute();
        ...
        $this->assertSame(FooJob::class, $data[2]['command']);
...
{
    protected ?string $signature = 'foo:command';
