 ...
 *
 * Usage:
 *   php tests/Integration/Reverb/Fixtures/server.php
 *   REVERB_SERVER_PORT=19511 REVERB_SCALING_ENABLED=true php tests/Integration/Reverb/Fixtures/server.php
 *   REVERB_SERVER_PORT=19512 REVERB_TEST_WORKER_NUM=2 php tests/Integration/Reverb/Fixtures/server.php
 *
 * Stop with Ctrl+C.
 */
