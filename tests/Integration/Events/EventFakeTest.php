...
namespace Hypervel\Tests\Integration\Events\EventFakeTest;
...
class EventFakeTest extends TestCase
{
    ...
    public function testAssertListening()
    {
        ...
        $listenersOfSameEventInRandomOrder = Arr::shuffle([
            'listener',
            'Hypervel\Tests\Integration\Events\EventFakeTest\PostAutoEventSubscriber@handle',
    ...
    public function testAssertNothingDispatchedShouldDispatchAfterCommit()
    {
        ...
        try {
            ...
            $this->assertStringContainsString("2 unexpected events were dispatched:\n\n- Hypervel\\Tests\\Integration\\Events\\EventFakeTest\\ShouldDispatchAfterCommitEvent dispatched 2 times", $e->getMessage());
        }
    }
}
