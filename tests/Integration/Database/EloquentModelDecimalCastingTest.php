...
namespace Hypervel\Tests\Integration\Database\EloquentModelDecimalCastingTest;
...
class EloquentModelDecimalCastingTest extends DatabaseTestCase
{
    ...
    public function testItWrapsThrownExceptions()
    {
        ...
        try {
            ...
            $this->assertSame('Value "foo" does not represent a valid number.', $e->getPrevious()->getMessage());
        }
    }
