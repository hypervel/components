...
/**
 * Tests dont_drop config with tables excluded on ALL schemas.
 *
...
class PostgresSchemaBuilderDontDropAllTest extends PostgresTestCase
{
    protected function defineEnvironment($app): void
    {
        ...
        $app['config']->set('database.connections.pgsql.dont_drop', ['spatial_ref_sys', 'table']);
    }
