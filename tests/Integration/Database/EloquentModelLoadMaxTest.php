...
namespace Hypervel\Tests\Integration\Database\EloquentModelLoadMaxTest;
...
class EloquentModelLoadMaxTest extends DatabaseTestCase
{
    ...
    public function testLoadMaxSingleRelation(): void
    {
    ...
    public function testLoadMaxMultipleRelations(): void
    {
        $model = BaseModel::first();
