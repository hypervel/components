...
TABLE, false);
    ...
    {
        yield ['[Hypervel](https://hypervel.org)', '<p><em>Hi</em> <a href="https://hypervel.org">Hypervel</a></p>'];

        yield [
            '![Welcome to Hypervel](https://hypervel.org/assets/img/welcome/background.svg)',
            '<p><em>Hi</em> <img src="https://hypervel.org/assets/img/welcome/background.svg" alt="Welcome to Hypervel"></p>',
        ];
