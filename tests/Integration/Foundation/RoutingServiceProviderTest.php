...
namespace Hypervel\Tests\Integration\Foundation\RoutingServiceProviderTest;
...
class RoutingServiceProviderTest extends TestCase
{
    ...
    public function testItHandlesGzippedBodyPayloadsWhenCreatingServerRequestInterfaceInstances()
    {
        ...
        $response = $this->call('POST', 'test-route', content: file_get_contents(__DIR__ . '/Fixtures/hypervel.txt.gz'));

        $response->assertOk();
        $response->assertContent("Hypervel\n");
    }
}
