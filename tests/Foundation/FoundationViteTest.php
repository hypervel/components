...
class FoundationViteTest extends TestCase
{
    ...
    public function testViteWithJsOnly()
    {
        ...
        $this->assertStringEndsWith('<script type="module" src="https://example.com/build/assets/app.versioned.js"></script>', (string) $result->toHtml());
    }
    ...
    protected function makeAsset($asset, $content)
    {
        ...
        file_put_contents($path . '/' . ltrim($asset, '/'), $content);
    }
    ...
    protected function makeViteManifest(?array $contents = null, string $path = 'build')
    {
