...
use Hypervel\Tests\Http\Fixtures\TestEnum;
use Hypervel\Tests\Http\Fixtures\TestEnumBacked;
use Hypervel\Tests\Http\Fixtures\TestIntegerEnumBacked;
...
class HttpRequestTest extends TestCase
{
    ...
    public function testSegmentMethod(string $path, int $segment, string $expected): void
    {
    ...
    public function testSegmentsMethod(string $path, array $expected): void
    {
        $request = Request::create($path);
    ...
    #[DataProvider('malformedBracketedHostProvider')]
    public function testPortParsingMatchesSymfonyForBracketedHostsWithoutClosingBracket(string $host, int $port): void
    {
    ...
    public static function malformedBracketedHostProvider(): array
    {
        return [
            'without a port' => ['[invalid', 80],
            'with a port' => ['[:8080', 8080],
        ];
    }
    ...
    public function testFullUrlWithoutQueryMethod(): void
    {
    ...
    {
        $request = Request::create('/', 'GET', [], [], [], [
            'HTTP_USER_AGENT' => 'Hypervel',
        ]);

        $this->assertSame('Hypervel', $request->userAgent());
    }

    public function testHostMethod(): void
    {
        $request = Request::create('http://example.com');
    ...
    public function testHttpHostMethod(): void
    {
        $request = Request::create('http://example.com');
    ...
    public function testSchemeAndHttpHostMethod(): void
    {
        $request = Request::create('http://example.com');
    ...
    public function testWhenHasMethod(): void
    {
        $request = Request::create('/', 'GET', ['name' => 'Taylor', 'age' => '', 'city' => null]);
    ...
    public function testWhenFilledMethod(): void
    {
        $request = Request::create('/', 'GET', ['name' => 'Taylor', 'age' => '', 'city' => null]);
    ...
    public function testWhenMissingMethod(): void
    {
    ...
    public function testIsNotFilledMethod(): void
    {
        $request = Request::create('/', 'GET', ['name' => 'Taylor', 'age' => '', 'city' => null]);
    ...
    public function testFilledAnyMethod(): void
    {
        $request = Request::create('/', 'GET', ['name' => 'Taylor', 'age' => '', 'city' => null]);
    ...
    public function testFluentMethod(): void
    {
        $request = Request::create('/', 'GET', [
            'user' => [
                'name' => 'Michael',
    ...
    public function testArrayAccessWithoutRouteResolver(): void
    {
        $request = Request::create('/', 'GET', ['name' => 'Taylor']);
    ...
    public function testMergeIfMissingMethod(): void
    {
        ...
        $request = Request::create('/', 'GET', ['user' => ['first_name' => 'Taylor', 'email' => 'taylor@hypervel.org']]);
    ...
    public function testBearerTokenMethod(): void
    {
    ...
    public function testJSONMethodDecodesTopLevelZero(): void
    {
    ...
    public function testPrefersMethod(string $accept, string|array $prefers, ?string $expected): void
    {
        $this->assertSame(
            $expected,
    ...
    public static function getPrefersCases(): array
    {
        return [
    ...
    public function testOldMethodCallsSessionWhenDefaultIsArray(): void
    {
        $request = Request::create('/');
        $session = m::mock(Store::class);
    ...
    public function testOldMethodCanGetDefaultValueFromModelByKey(): void
    {
        $request = Request::create('/');
    ...
    public function testWantsMarkdown(): void
    {
    ...
    public function testAcceptsMarkdown(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => 'text/markdown']);
    ...
    public function testWantsJsonRespectsHeaderChanges(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*/*']);
    ...
    public function testAcceptsJsonRespectsHeaderChanges(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*/*']);
    ...
    public function testPrefersRespectsHeaderChanges(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*/*']);
    ...
    public function testWantsJsonWorksWhenHeaderSetBeforeFirstCall(): void
    {
        $request = Request::create('/', 'GET', [], [], [], []);
    ...
    public function testCacheClearedWhenTransitioningFromUnsetToSetHeader(): void
    {
        $request = Request::create('/', 'GET', [], [], [], []);
    ...
    public function testAcceptsJsonWorksWhenHeaderChangedMultipleTimes(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => 'text/html']);
    ...
    public function testCaseInsensitiveAcceptHeader(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => 'APPLICATION/JSON']);
        $this->assertTrue($request->accepts(['text/html', 'application/json']));
    ...
    public function testHasSessionMethod(): void
    {
        $request = Request::create('/');
    ...
    public function testGetSessionMethodWithHypervelSession(): void
    {
        $request = Request::create('/');

        $hypervelSession = m::mock(Store::class);
        $request->setHypervelSession($hypervelSession);
    ...
    public function testGetSessionMethodWithoutHypervelSession(): void
    {
     ...
     */
    public function testNonJsonRequestDoesntFillRequestBodyParams(): void
    {
        $params = ['foo' => 'bar'];
    ...
    public function testItCanHaveObjectsInJsonPayload(): void
    {
        $base = SymfonyRequest::create('/', 'POST', server: ['CONTENT_TYPE' => 'application/json'], content: '{"framework":{"name":"Hypervel"}}');
        $request = Request::createFromBase($base);

        $this->assertSame(['name' => 'Hypervel'], $request->input('framework'));
    }
    ...
    public function testItDoesNotGenerateJsonErrorsForEmptyContent(): void
    {
