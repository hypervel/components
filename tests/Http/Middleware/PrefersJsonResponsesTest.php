...
{
    public function testItRewritesMissingAcceptHeader(): void
    {
    ...
    public function testItRewritesEmptyAcceptHeader(): void
    {
    ...
    public function testItRewritesStarSlashStarAcceptHeader(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*/*']);
    ...
    public function testItDoesNotRewriteBareStarAcceptHeader(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*']);
    ...
    public function testItRewritesApplicationWildcardAcceptHeader(): void
    {
    ...
    public function testItRewritesBroadAcceptHeaderWithQualityParameter(): void
    {
    ...
    public function testItRewritesMultipleBroadMarkers(): void
    {
    ...
    public function testItInvokesNextAndReturnsItsResponse(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*/*']);
        ...
        $result = (new PrefersJsonResponses)->handle($request, function (Request $passed) use ($request, &$called, $expected): Response {
            $called = true;
    ...
    public function testItLeavesExplicitHtmlAcceptHeader(): void
    {
    ...
    public function testItLeavesExplicitXmlAcceptHeader(): void
    {
    ...
    public function testItLeavesExplicitPlainTextAcceptHeader(): void
    {
    ...
    public function testItLeavesMultiValueExplicitAcceptList(): void
    {
    ...
    public function testItLeavesMixedBroadAndExplicitAcceptList(): void
    {
        $request = Request::create('/', 'GET', [], [], [], [
    ...
    public function testItLeavesWildcardFirstMixedAcceptList(): void
    {
        $request = Request::create('/', 'GET', [], [], [], ['HTTP_ACCEPT' => '*/*, text/html']);
    ...
    public function testItLeavesExplicitJsonAcceptHeader(): void
    {
    ...
    public function testItDoesNotMutateBodyMethodUriQueryOrOtherHeaders(): void
    {
    ...
    {
        (new PrefersJsonResponses)->handle($request, static fn (Request $request): Response => new Response);
    }
}
