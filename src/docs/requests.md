...
If the uploaded file is an image that you need to manipulate before storing, you may use the `image` method to retrieve a `Hypervel\Image\Image` instance, or `null` if the file is not present:
