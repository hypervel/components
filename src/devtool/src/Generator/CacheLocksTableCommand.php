...
class CacheLocksTableCommand extends GeneratorCommand
{
    ...
    {
        parent::__construct('make:cache-locks-table');
    }

    public function configure()
    {
        $this->setDescription('Create a migration for the cache locks database table');
    ...
    {
        return $this->getConfig()['stub'] ?? __DIR__ . '/stubs/cache-locks-table.stub';
    }
