...
<div
    ...
    x-init="
        highlightedCode = window.highlight(
            {{ Hypervel\Support\Js::from($code) }},
            {{ Hypervel\Support\Js::from($language) }},
            {{ Hypervel\Support\Js::from($truncate) }},
            {{ Hypervel\Support\Js::from($editor) }},
            {{ Hypervel\Support\Js::from($startingLine) }},
            {{ Hypervel\Support\Js::from($highlightedLine) }}
        );
    "
    {{ $attributes }}
>
