...
return [
    ...
    | Testbench default stays local in package mode because throttle middleware
    | may run while the standard database migrations remain opt-in.
    |
    */

    'default' => env('RATE_LIMITER_STORE', 'worker-array'),
