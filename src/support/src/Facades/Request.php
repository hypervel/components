 ...
 * @method static string|int|null getPort()
 ...
 * @method static ($key is null ? \Symfony\Component\HttpFoundation\InputBag : mixed) json(string|null $key = null, mixed $default = null)
 ...
 * @method static ($param is null ? null|\Hypervel\Routing\Route : null|object|string) route(string|null $param = null, mixed $default = null)
 ...
 * @method static \Hypervel\Http\Request|mixed whenEnum(string $key, string $enumClass, callable $callback, callable|null $default = null)
 ...
 * @method static int|float clamp(string $key, int|float $min, int|float $max, int|float $default = 0)
