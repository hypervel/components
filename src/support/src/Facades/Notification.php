 ...
 * @method static \Hypervel\Notifications\ChannelManager extend(string $driver, \Closure $callback)
 ...
 * @method static void assertSentTo(mixed $notifiable, \Closure|string $notification, callable|int|null $callback = null)
