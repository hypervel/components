 ...
 * @method static \Hypervel\Foundation\Exceptions\Handler dontRetry(array|string $exceptions)
 * @method static \Hypervel\Foundation\Exceptions\Handler dontRetryWhen(callable $dontRetryWhen)
