 ...
 * @method static array<int, string> getColumnListing(string $table)
 * @method static array<int, array> getColumns(string $table)
 ...
 * @method static array<int, array> getTypes(array|string|null $schema = null)
 * @method static array<int, array> getViews(array|string|null $schema = null)
 ...
 * @method static void truncateTables(array<int, string> $tables)
