 ...
 * @method static \GuzzleHttp\Promise\PromiseInterface response(mixed $body = null, int $status = 200, array $headers = [])
 * @method static \GuzzleHttp\Psr7\Response psr7Response(mixed $body = null, int $status = 200, array $headers = [])
