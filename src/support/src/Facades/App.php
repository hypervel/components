 ...
 * @method static object|mixed makeWith(string $abstract, array $parameters = [])
 * @method static object|mixed make(string $abstract, array $parameters = [])
 * @method static object|mixed get(string $id)
 * @method static object|mixed buildWith(string|\Closure $concrete, array<string, mixed> $parameters = [])
 ...
 * @method static \Hypervel\Foundation\Application getInstance()
 * @method static \Hypervel\Contracts\Container\Container|null setInstance(\Hypervel\Contracts\Container\Container|null $container = null)
