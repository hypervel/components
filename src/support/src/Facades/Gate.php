 ...
 * @method static \Hypervel\Database\Eloquent\Builder scope(\UnitEnum|string $ability, \Hypervel\Database\Eloquent\Builder $query)
 * @method static \Hypervel\Contracts\Database\Query\Expression|\Hypervel\Database\Query\Builder select(\UnitEnum|string $ability, \Hypervel\Database\Eloquent\Builder|string|\Hypervel\Database\Eloquent\Model $query)
