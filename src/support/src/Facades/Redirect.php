 ...
 * @method static \Hypervel\Http\RedirectResponse signedRoute(\BackedEnum|string $route, mixed $parameters = [], \DateInterval|\DateTimeInterface|int|null $expiration = null, int $status = 302, array $headers = [])
 * @method static \Hypervel\Http\RedirectResponse temporarySignedRoute(\BackedEnum|string $route, \DateInterval|\DateTimeInterface|int $expiration, mixed $parameters = [], int $status = 302, array $headers = [])
 * @method static \Hypervel\Http\RedirectResponse action(array|string $action, mixed $parameters = [], int $status = 302, array $headers = [])
