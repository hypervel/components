 ...
 * @method static string temporarySignedRoute(\BackedEnum|string $name, \DateInterval|\DateTimeInterface|int $expiration, mixed $parameters = [], bool $absolute = true)
 ...
 * @method static string action(array|string $action, mixed $parameters = [], bool $absolute = true)
 ...
 * @method static void resolveDefaultsUsing(\Closure|null $resolver)
 * @method static void defaults(array $defaults)
 * @method static array getDefaultParameters()
 * @method static void useDefaults(array|null $defaults)
 * @method static void forceScheme(string|null $scheme)
 * @method static string|null getForcedScheme()
