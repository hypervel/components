 ...
 * @method static mixed get(array|\UnitEnum|string $key, mixed $default = null)
 * @method static bool set(\UnitEnum|string $key, mixed $value, null|int|\DateInterval $ttl = null)
 * @method static bool delete(\UnitEnum|string $key)
 * @method static bool clear()
 * @method static iterable<string, mixed> getMultiple(iterable<\UnitEnum|string> $keys, mixed $default = null)
 * @method static bool setMultiple(iterable $values, null|int|\DateInterval $ttl = null)
 * @method static bool deleteMultiple(iterable<\UnitEnum|string> $keys)
 * @method static bool has(array|\UnitEnum|string $key)
