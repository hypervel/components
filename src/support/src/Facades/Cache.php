 ...
 * @method static mixed get(\UnitEnum|array|string $key, \Closure|mixed $default = null)
 * @method static array many(array $keys)
 * @method static iterable<string, mixed> getMultiple(iterable<string|\UnitEnum> $keys, mixed $default = null)
 ...
 * @method static bool set(\UnitEnum|string $key, mixed $value, \DateInterval|\DateTimeInterface|int|null $ttl = null)
 * @method static bool putMany(array $values, \DateInterval|\DateTimeInterface|int|null $ttl = null)
 * @method static bool setMultiple(iterable $values, \DateInterval|\DateTimeInterface|int|null $ttl = null)
 ...
 * @method static bool delete(\UnitEnum|string $key)
 * @method static bool deleteMultiple(iterable<string|\UnitEnum> $keys)
