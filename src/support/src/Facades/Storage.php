 ...
 * @method static string|bool put(string $path, resource|\Psr\Http\Message\StreamInterface|string|\Hypervel\Http\UploadedFile $contents, mixed $options = [])
 * @method static string|false putFile(\Hypervel\Http\UploadedFile|string $path, \Hypervel\Http\UploadedFile|array|string|null $file = null, mixed $options = [])
 * @method static string|false putFileAs(\Hypervel\Http\UploadedFile|string $path, \Hypervel\Http\UploadedFile|array|string|null $file, array|string|null $name = null, mixed $options = [])
 ...
 * @method static \Hypervel\Filesystem\FilesystemAdapter|mixed when(null|\Closure|mixed $value = null, null|callable $callback = null, null|callable $default = null)
 * @method static \Hypervel\Filesystem\FilesystemAdapter|mixed unless(null|\Closure|mixed $value = null, null|callable $callback = null, null|callable $default = null)
