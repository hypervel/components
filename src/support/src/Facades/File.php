 ...
 * @method static int|bool put(string $path, resource|string $contents, bool $lock = false)
 ...
 * @method static \Symfony\Component\Finder\SplFileInfo[] files(array|string $directory, bool $hidden = false, array|string|int $depth = 0)
 * @method static \Symfony\Component\Finder\SplFileInfo[] allFiles(array|string $directory, bool $hidden = false)
 ...
 * @method static \Hypervel\Filesystem\Filesystem|mixed when(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
 * @method static \Hypervel\Filesystem\Filesystem|mixed unless(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
