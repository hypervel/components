 ...
 * @method static mixed pushOn(string|null $queue, string|object $job, mixed $data = '')
 ...
 * @method static mixed laterOn(string|null $queue, \DateTimeInterface|\DateInterval|int $delay, string|object $job, mixed $data = '')
 ...
 * @method static \Hypervel\Support\Collection pushedRaw(null|\Closure $callback = null)
 * @method static \Hypervel\Support\Collection listenersPushed(string $listenerClass, \Closure|null $callback = null)
