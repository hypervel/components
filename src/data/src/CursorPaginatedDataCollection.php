 ...
 */
class CursorPaginatedDataCollection implements BaseDataCollectableContract, TransformableDataContract, IncludeableDataContract, ResponsableDataContract, WrappableDataContract, Countable, Transient
{
    ...
    /** @var AbstractCursorPaginator<TKey, TValue> */
    protected AbstractCursorPaginator $items;

    /**
     * Create a typed cursor-paginated data collection.
     *
     * @param class-string<TValue> $dataClass
     * @param AbstractCursorPaginator<TKey, mixed> $items
     */
    public function __construct(
        public readonly string $dataClass,
        AbstractCursorPaginator $items,
    ) {
    ...
    /**
     * Get the underlying cursor paginator.
     *
     * @return AbstractCursorPaginator<TKey, TValue>
     */
