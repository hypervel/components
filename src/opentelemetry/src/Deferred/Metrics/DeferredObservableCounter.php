...
/**
 * Keep a pre-fork observable counter and its creation callbacks replayable.
 *
 * @internal
 */
class DeferredObservableCounter implements ObservableCounterInterface
{
    protected ?ObservableCounterInterface $delegate = null;

    /**
     * Create a deferred observable counter.
     *
    ...
    {
        $this->delegate = $meter->createObservableCounter(
            $this->name,
            $this->unit,
            $this->description,
            $this->advisory,
     ...
     */
    public function delegate(): ?ObservableCounterInterface
    {
        return $this->delegate;
    }

    /**
     * Determine whether the current observable counter is enabled.
     */
    #[Override]
