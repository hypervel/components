...
/**
 * Keep a pre-fork observable up-down counter and its callbacks replayable.
 *
 * @internal
 */
class DeferredObservableUpDownCounter implements ObservableUpDownCounterInterface
{
    protected ?ObservableUpDownCounterInterface $delegate = null;

    /**
     * Create a deferred observable up-down counter.
     *
    ...
    {
        $this->delegate = $meter->createObservableUpDownCounter(
            $this->name,
            $this->unit,
            $this->description,
            $this->advisory,
     ...
     */
    public function delegate(): ?ObservableUpDownCounterInterface
    {
        return $this->delegate;
    }

    /**
     * Determine whether the current observable up-down counter is enabled.
     */
    #[Override]
