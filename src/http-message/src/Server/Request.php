...
class Request extends BaseRequest implements ServerRequestInterface, ServerRequestPlusInterface
{
     ...
     */
    public static function loadFromSwooleRequest(Swoole\Http\Request $swooleRequest): static
    {
    ...
    /**
     * Get the parser result of the body.
     */
    ...
    /**
     * Return an instance with the specified body parameters from the parser result.
     */
    ...
    /**
     * Set the underlying Swoole request.
     */
    ...
    /**
     * Set a derived request attribute.
     */
    ...
    /**
     * Get the request parser instance.
     */
