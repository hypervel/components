...
class Response implements ResponseInterface, ResponsePlusInterface, Stringable
{
    ...
    /**
     * Get the string representation of the response body.
     */
    ...
    public function isRedirect(?string $location = null): bool
    {
        return in_array($this->statusCode, [
            ...
            307,
            308,
        ], true) && ($location === null || $location === $this->getHeaderLine('Location'));
    }
    ...
    /**
     * Serialize the response to an HTTP string.
     */
    ...
    /**
     * Set the response status code and optional reason phrase.
     */
