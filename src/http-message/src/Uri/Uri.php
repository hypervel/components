...
class Uri implements UriInterface, UriPlusInterface, Stringable
{
    ...
    /**
     * Determine whether the URI has the default port of the current scheme.
     *
    ...
    /**
     * Get the default port of the current scheme.
     */
    ...
    /**
     * Filter and normalize the URI scheme.
     */
    ...
    /**
     * Filter and normalize the URI host.
     */
    ...
    /**
     * URL-encode the first match element.
     */
