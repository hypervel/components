...
<head>
    ...
    <title>Horizon{{ config()->string('horizon.name') ? ' - ' . config()->string('horizon.name') : '' }}</title>
        ...
        <div class="d-flex align-items-center py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                ...
                <h1 class="h4 mb-0 ms-2">
                    <strong>Hypervel</strong> Horizon{{ config()->string('horizon.name') ? ' - ' . config()->string('horizon.name') : '' }}
                </h1>
            </router-link>
